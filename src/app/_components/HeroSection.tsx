...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen sm:min-h-[50vh] bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 text-white flex items-center justify-center overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:py-16">
        <div className="text-center">
          ...
          >
            SNSアイコンを一括管理！面倒な管理はもうおしまい。
            <br className="hidden sm:block" />
            お気に入りのアイコンを登録して、どこからでもダウンロードしましょう！
          </motion.p>
